    ...
    def create_env_example(self):
        ...
        try:
            with open(example_path, 'w') as f:
                ...
                categories = {
                    "API Keys": ["ACOUSTID_API_KEY", "DISCOGS_CONSUMER_KEY", "DISCOGS_CONSUMER_SECRET", 
                                "DISCOGS_REQUEST_TOKEN_URL", "DISCOGS_AUTHORIZE_URL", "DISCOGS_ACCESS_TOKEN_URL"],
                    
                    "File Paths": ["DEFAULT_INPUT_DIR", "DEFAULT_OUTPUT_DIR"],
                    
                    "UI Configuration": ["WINDOW_WIDTH", "WINDOW_HEIGHT", "FULLSCREEN", "THEME"],
                    
                    "Processing Settings": ["MAX_THREADS", "AUTO_ADJUST_THREADS", "UI_UPDATE_INTERVAL_MS", 
                                            "OPTIMIZE_SYSTEM"],
                    
                    "File Organization": ["ORGANIZE_BY_LANGUAGE", "USE_AUDIO_LANGUAGE_DETECTION", 
                                          "DETECT_AUDIO_SIMILARITY", "KEEP_ALL_DUPLICATES", "HANDLE_DUPLICATES", 
                                          "RENAME_FILES", "REMOVE_EMPTY_DIRS", "SAVE_ORIGINAL_NAMES"],
                    ...
                    "Metadata Settings": ["USE_MUSICBRAINZ", "USE_DISCOGS", "FETCH_LYRICS", "SOURCE_PRIORITY"],
