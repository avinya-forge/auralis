...
class TestMusicOrganizer:
    ...
    def mock_services(self):
        ...
        with patch(
            "src.core.organizer.is_language_detection_available", return_value=True
        ) as m1, patch(
            "src.core.organizer.get_language_folder", return_value="English"
        ) as m2, patch(
            "src.core.organizer.is_audio_similarity_available", return_value=True
        ) as m3, patch(
    ...
    def test_init(self, organizer, mock_services):
        ...
        with patch("src.core.organizer.is_language_detection_available", return_value=False), patch(
            "src.core.organizer.is_audio_similarity_available", return_value=False
        ):
            org = MusicOrganizer()
    ...
    def test_organize_files_basic(self, qapp, mock_services, tmp_path):
        ...
        options = {"organize_by_language": False, "rename_files": False}
    ...
    def test_organize_files_renaming(self, organizer, tmp_path):
        ...
        dest_root = str(tmp_path / "Output")
        options = {"organize_by_language": False, "rename_files": True}
    ...
    def test_audio_similarity(self, organizer, mock_services, tmp_path):
        ...
        dest_root = str(tmp_path / "Output")
        options = {"detect_audio_similarity": True, "keep_all_duplicates": False}
