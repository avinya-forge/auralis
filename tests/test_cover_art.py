...
class TestCoverArt:
    ...
    def test_apply_metadata_with_cover_art_mp3(self, service):
        ...
        with patch("src.services.metadata_service.mutagen.File", return_value=mock_audio), patch(
            "src.services.metadata_service.mutagen.mp3.MP3", MockMP3
    ...
    def test_apply_metadata_with_cover_art_flac(self, service):
        ...
        with patch("src.services.metadata_service.mutagen.File", return_value=mock_audio), patch(
            "src.services.metadata_service.mutagen.flac.FLAC", MockFLAC
