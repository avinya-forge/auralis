...
- [MET-009] | Add `GenreClassifier` using `mutagen` basic tags | [INDEPENDENT] | [DONE]
- [MET-010] | Implement `MetadataSanitizer` (remove comments, unknown tags) | [INDEPENDENT] | [DONE]

### Epic 5: UI/UX Refinement
- [UI-001] | Create `ThemeManager` class (Singleton) | [INDEPENDENT] | [DONE]
- [UI-002] | Define JSON Schema for Theme files | [BLOCKS-UI-001] | [DONE]
- [UI-003] | Create `dark_theme.json` | [BLOCKS-UI-002] | [DONE]
