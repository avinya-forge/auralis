...
- [TYP-001] | Enable `disallow_untyped_defs = True` in `mypy.ini` for `src.core` | [INDEPENDENT] | [TODO]
- [TYP-002] | Resolve type errors in `src/core/scanner.py` | [BLOCKS-TYP-001] | [TODO]
- [TYP-003] | Enable `disallow_untyped_defs = True` in `mypy.ini` for `src.services` | [INDEPENDENT] | [TODO]
- [TYP-004] | Resolve type errors in `src/services/metadata_service.py` | [BLOCKS-TYP-003] | [TODO]
- [TYP-005] | Resolve type errors in `src/services/lyrics_service.py` | [BLOCKS-TYP-003] | [TODO]
- [TYP-006] | Enable `disallow_untyped_defs = True` in `mypy.ini` for `src.utils` | [INDEPENDENT] | [TODO]
- [TYP-007] | Resolve type errors in `src/utils/file_utils.py` | [BLOCKS-TYP-006] | [TODO]
- [TYP-008] | Resolve type errors in `src/utils/system_utils.py` | [BLOCKS-TYP-006] | [TODO]
- [TYP-009] | Enable strict typing for `src.gui` (remove ignore) | [INDEPENDENT] | [TODO]
- [TYP-010] | Resolve type errors in `src/gui/wx/main_window.py` | [BLOCKS-TYP-009] | [TODO]
- [TYP-011] | Resolve type errors in `src/gui/wx/tabs/*.py` | [BLOCKS-TYP-009] | [TODO]
- [TYP-012] | Enable strict typing for `src.cli` (remove ignore) | [INDEPENDENT] | [TODO]
- [TYP-013] | Resolve type errors in `src/cli/cli_main.py` | [BLOCKS-TYP-012] | [TODO]

### Epic 2: Test Fortress (95% Coverage)
- [TST-001] | Create `tests/test_cli_main.py` using `unittest.mock` | [INDEPENDENT] | [TODO]
...
- [MET-007] | Implement `MusixmatchLyricsProvider` | [BLOCKS-MET-005] | [TODO]
- [MET-008] | Add `AlbumArtFetcher` with size filtering | [INDEPENDENT] | [TODO]
